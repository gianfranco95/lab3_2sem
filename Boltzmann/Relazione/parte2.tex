...
\begin{table}[h]
	...
	\label{t:frequenza}
\end{table}
In \fig{frequenza} è mostrato il plot di Bode. Un fit, eseguito con la funzione di trasferimento mostrata in \ref{e:funzione}, a 3 parametri, dà come risultati f$_0 =$  \\
%\begin{equation}
%\frac{2 \pi A_0 f}{\sqrt{f_2 + {2 \pi f-f_i}^^2} \sqrt{f_2 + {2 \pi f-f_i}^^2}}
%\label{e:funzione}
%\end{equation}
