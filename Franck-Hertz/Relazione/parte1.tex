...
Abbiamo ricercato il valore di $U_E = 10.2$ V per cui i minimi si disponessero approssimativamente a $I_C = 0$ nA come in \fig{figura_3}.??spiegare a cosa può servire forse ad ottenere una larghezza della campana di energia\\
