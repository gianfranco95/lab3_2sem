...
In \fig{passabanda} è mostrato il grafico dell'amplificazione in funzione della frequenza (plot di Bode). Abbiamo realizzato un fit con la funzione di trasferimento \ref{passabanda}, ottenendo:
\begin{itemize}
...
L'amplificazione attesa a centro banda è pari a A$_{att} = \frac{R_{3pb}}{2R_{1pb}} (1+\frac{R_{2pa}}{R_{1pa}}) = 308 \pm 5 = 49.8 \pm 0.1$ [dB]. I pedici pb e pa si riferiscono rispettivamente al passa-banda ed al post-amplificatore.