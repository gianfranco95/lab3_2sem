...
Il circuito è stato montato a blocchi e l'ingresso del circuito completo è stato prelevato dal generatore d'onda ,corrispondente ad un onda sinusoidale di ampiezza picco-picco $5.80 \pm 0.04 [V]$ e frequenza $1.04 \pm 0.01 [kHz]$.
...
E' stato montato il circuito in \fig{adattamento_fase}, utilizzando le resistenze e condensatori di seguito indicati(gli errori sono quelli calcolati col tester):
\begin{itemize}
...
Agendo sul trimmer P2 si può aggiungere un ulteriore sfasamento di $156 \pm 5$ gradi , (errore calcolato in base agli errori ottenuti dalle misure temporali con l'oscilloscopio.)

\section{Squadratore e campionatore}
E' stato montato il circuito in \fig{squadratore} e si è verificato che le onde quadre in S4 e S5 fossero in opposizione di fase come in \fig{s4-s5}. Successivamente sono stati osservati i segnali S7 e S8 ,prima separatamente e poi contemporaneamente ; i relativi grafici sono in \fig{}, \fig{}, \fig{}, \fig{}. 

per amplificatore differenziale
