...
Abbiamo realizzato anche un grafico di e/m in funzione di V$_{acc}$, riportato in \fig{figura_8}, mentre in \fig{figura_9} è rappresentato un istogramma diviso in barre spesse 0.1 V/C, con il numero di occorrenze di e/m per ogni barra sulle ordinate. Abbiamo infine riportato in \fig{figura_10} un grafico di ${B_z r}^2$(V$_{acc}$).
