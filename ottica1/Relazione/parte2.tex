...
Si nota dal grafico in (\fig{rydberg1}) che la misura associata alla riga verde si discosta molto ( $ \approx 40\space \sigma$ ) dall'andamento lineare. Rimuovendo questa misura dal fit numerico (\fig{rydberg2}) si ottiene un nuovo valore per la costante di Rydberg:
\begin{itemize}
