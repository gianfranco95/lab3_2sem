...
%tabella generatore onde quadre

\begin{table}[h]
	\centering
	\begin{tabular}{*{4}{S[table-figures-exponent = 2]} }
		{R$_1$ [$\Omega$]} & dR$_1$ [$\Omega$]} & R$_2$ [$\Omega$]} & dR$_2$ [$\Omega$]} & {t [$\mu $s]} & {$\Delta$t [$\mu $s]} & T [$\mu $s]} & {$\Delta$T [$\mu $s]} \\
		\midrule
           385 & ?? & 456 & ?? & 31 & 1 & 95 & 1\\
           456 & ?? & 560 & ?? & 35.6 & 0.4 & 113 & 1\\
           456 & ?? & 985 & ?? & 37.6 & 0.4 & 191 & 1\\
           675 & ?? & 985 & ?? & 58.8 & 0.4 & 189 & 1 \\
           985 & ?? & 456 & ?? & 67.2 & 0.4 & 94 & 1\\
           985 & ?? & 1173 & ?? & 91 & 1 & 223 & 1\\
 	\end{tabular}
	\caption{}
	\label{t:onde_quadre}
